import re  # Fixed: 'Import' must be lowercase 'import'
...
# Fixed: bool("False") is actually True in Python. Use is_enabled instead.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002042829477')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002042829477')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002042829477')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = is_enabled(environ.get("NO_RESULTS_MSG", "False"), False) # Fixed boolean logic
...
# Verify/token system
VERIFY = is_enabled(environ.get('VERIFY', "False"), False) # Fixed boolean logic
...
IS_SHORTLINK = is_enabled(environ.get('IS_SHORTLINK', "False"), False) # Fixed boolean logic
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = int(environ.get("PORT", "8080")) # Fixed integer conversion
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+rC0W_RoQBCc1MGY1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/korean_drama_serieshindi')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Ultroid_Official/18')
IS_TUTORIAL = is_enabled(environ.get('IS_TUTORIAL', "True"), True) # Fixed boolean logic
...
# Online Stream and Download logic
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003272869789'))
