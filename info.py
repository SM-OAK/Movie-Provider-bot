...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-5258485713').split()] #Channel id for auto indexing ( make sure bot is admin )
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003693769696')) #Log channel id ( make sure bot is admin )
